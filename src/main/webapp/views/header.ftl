        ...
        <div class="container">
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href="/cart" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm" id="cartNum"><#if Session.cart??>${Session.cart.getTotalCount()}<#else>0</#if></span></a>
                </div>
                <!--/.nav-collapse -->
